...
<body>
  ...
  <div class="mySlides">
     <center><img src="/asset/image/ecommerce.jpg" class="img" width="80%" height="500px"></center>
  </div>
...
<a class="next" onclick="plusSlides(1)">❯</a>
	...
	<form action="/customer/product" method="post">
		@csrf
		  <div class="grid_item border bg-light" style="padding:20px">
				<center><img src="{{ asset('cover/' . $items->cover_image) }}" class="cover_image" style="width:300px;height:300px" /><br/>
				<strong>{{ $items->product_name }}</strong><br/><br/>
				<input type="number" value="{{ $items->id }}" name="p_id" hidden/>
